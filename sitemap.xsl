  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body>
        <div id="header">
          <h1>XML Sitemap</h1>
          <h2>This is a XML Sitemap which is supposed to be processed by Search Engines such as
            <a href="https://www.google.com/webmasters/tools/">Google</a>
            -
            <a href="https://search.yahoo.com/info/submit.html">Yahoo</a>
            -
            <a href="http://www.bing.com/toolbox/webmaster">Bing</a>
          </h2>
        </div>
        <div id="content">
